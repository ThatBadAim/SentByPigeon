...
class AppDatabaseTest {
    ...
    fun getPendingMessages_returnsMessagesWithPendingStatus() = runTest {
        ...
        val pendingMessage = MessageEntity(
            ...
            timestamp = 1000L, encryptionStatus = EncryptionStatus.PENDING, replyToMessageId = null, syncState = com.hybrid.messaging.core.model.SyncState.SENT
        )
        val encryptedMessage = MessageEntity(
            ...
            timestamp = 1001L, encryptionStatus = EncryptionStatus.ENCRYPTED_SIGNAL_V3, replyToMessageId = null, syncState = com.hybrid.messaging.core.model.SyncState.SENT
        )
    ...
    fun getMessagesForRoom_returnsOrderedByTimestampDesc() = runTest {
        ...
        val msg1 = MessageEntity("m1", "ch1", "u1", "U", null, "1", MessageType.TEXT, null, null, 1000L, EncryptionStatus.UNENCRYPTED, null, com.hybrid.messaging.core.model.SyncState.SENT)
        val msg2 = MessageEntity("m2", "ch1", "u1", "U", null, "2", MessageType.TEXT, null, null, 2000L, EncryptionStatus.UNENCRYPTED, null, com.hybrid.messaging.core.model.SyncState.SENT)
    ...
    fun cascadingDelete_ChatRoom_CascadesToMessages() = runTest {
        ...
        val message = MessageEntity(
            ...
            replyToMessageId = null, syncState = com.hybrid.messaging.core.model.SyncState.SENT
        )
